...
const GITHUB_COMPARE_URL = 'https://api.github.com/repos/Darkaxt/feishin-basic-auth/compare';
...
const ReleaseNotesContent = ({ onDismiss, version }: ReleaseNotesContentProps) => {
            ...
            <Stack gap="md">
                ...
                <Group justify="flex-end">
                    <Button
                        ...
                        href={
                            showCompareError
                                ? `https://github.com/Darkaxt/feishin-basic-auth/compare/${latestStableRelease.tag_name}...${toTag(selectedVersion)}`
                                : `https://github.com/Darkaxt/feishin-basic-auth/releases/tag/${toTag(selectedVersion)}`
                        }
                        onClick={onDismiss}
        ...
        return (
            <Stack gap="md">
                ...
                <Group justify="flex-end">
                    <Button
                        component="a"
                        href={`https://github.com/Darkaxt/feishin-basic-auth/releases/tag/${toTag(selectedVersion)}`}
                        onClick={onDismiss}
                        rightSection={<Icon icon="externalLink" />}
                        target="_blank"
                        variant="subtle"
    ...
    if (isAlpha && compareData) {
        ...
        const compareUrl = `https://github.com/Darkaxt/feishin-basic-auth/compare/${latestStableRelease?.tag_name}...development`;
        return (
            <Stack gap="md">
                {releaseOptions.length > 1 && (
                    <Select
