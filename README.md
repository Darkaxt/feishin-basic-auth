...
This repository only tracks BasicAuth/proxy-auth changes carried by this fork.
  ...
  <p align="center">
    <a href="https://github.com/Darkaxt/feishin-basic-auth/blob/development/LICENSE">
      ...
      <a href="https://github.com/Darkaxt/feishin-basic-auth/releases/tag/v1.15.1-ba.16">
...
Current prerelease: [v1.15.1-ba.16](https://github.com/Darkaxt/feishin-basic-auth/releases/tag/v1.15.1-ba.16).
...
systems, use
[`Feishin-1.15.1-ba.16-win-x64.exe`](https://github.com/Darkaxt/feishin-basic-auth/releases/download/v1.15.1-ba.16/Feishin-1.15.1-ba.16-win-x64.exe).
The architecture-neutral Windows installer is
[`Feishin-1.15.1-ba.16-win.exe`](https://github.com/Darkaxt/feishin-basic-auth/releases/download/v1.15.1-ba.16/Feishin-1.15.1-ba.16-win.exe).
